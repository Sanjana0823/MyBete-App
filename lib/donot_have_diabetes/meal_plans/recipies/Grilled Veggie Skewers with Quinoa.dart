...
class D4RecipeDetailScreen extends StatefulWidget {
  const D4RecipeDetailScreen({Key? key}) : super(key: key);

  @override
  _D4RecipeDetailScreenState createState() => _D4RecipeDetailScreenState();
}

class _D4RecipeDetailScreenState extends State<D4RecipeDetailScreen> {
  ...
  // Recipe data
  final String recipeName = ' Grilled Veggie Skewers with Quinoa';
    ...
    try {
      ...
      Map<String, dynamic> recipeData = {
        ...
        'instructions': [
          ...
          'Thread zucchini, bell peppers, and onion onto skewers.',
          'Drizzle with olive oil, balsamic vinegar, salt, and pepper.',
          'Grill the skewers for 5-6 minutes per side until tender.',
    ...
    return Scaffold(
      body: Stack(
        children: [
          // Background Image
          Image.asset(
            'lib/donot_have_diabetes/meal_plans/meal_images/Easy Tofu Skewers (Grill or Oven!) - Two Spoons.jpeg',
                          ...
                          Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                _buildBulletPoint('1 zucchini (sliced)'),
                                _buildBulletPoint('1 red bell pepper (sliced)'),
                                _buildBulletPoint('1 yellow bell pepper (sliced)'),
                                _buildBulletPoint('1 red onion (sliced)'),
                                _buildBulletPoint('1 cup quinoa'),
                                ...
                                const SizedBox(height: 8),
                                _buildNumberedStep(1, 'Preheat grill or grill pan to medium heat.'),
                                const SizedBox(height: 8),
                                _buildNumberedStep(2, 'Thread zucchini, bell peppers, and onion onto skewers.'),
                                const SizedBox(height: 8),
                                _buildNumberedStep(3, 'Drizzle with olive oil, balsamic vinegar, salt, and pepper.'),
                                const SizedBox(height: 8),
                                _buildNumberedStep(4, 'Grill the skewers for 5-6 minutes per side until tender.'),
                                const SizedBox(height: 8),
                                _buildNumberedStep(5, 'Serve with a side of quinoa.'),
