...
class S5RecipeDetailScreen extends StatefulWidget {
  const S5RecipeDetailScreen({Key? key}) : super(key: key);

  @override
  _S5RecipeDetailScreenState createState() => _S5RecipeDetailScreenState();
}

class _S5RecipeDetailScreenState extends State<S5RecipeDetailScreen> {
  ...
  // Recipe data
  final String recipeName = 'Rice Cake with Nut Butter';
  final int calories = 180;
  ...
  Future<void> _saveRecipe() async {
    ...
    try {
      ...
      Map<String, dynamic> recipeData = {
        ...
        'instructions': [
          'Spread nut butter on top of the rice cake.',
          'Enjoy the crunchy, creamy snack!',
        ],
        'savedAt': FieldValue.serverTimestamp(),
        'imagePath': 'lib/donot_have_diabetes/meal_plans/meal_images/Rice Cakes with Peanut Butter.jpeg',
      };
    ...
    return Scaffold(
      body: Stack(
        children: [
          // Background Image
          Image.asset(
            'lib/donot_have_diabetes/meal_plans/meal_images/Rice Cakes with Peanut Butter.jpeg',
                          ...
                          Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                _buildBulletPoint('1 rice cake'),
                                _buildBulletPoint('1 tbsp peanut butter (or almond butter)'),
                                ...
                                const SizedBox(height: 8),
                                _buildNumberedStep(1, 'Spread nut butter on top of the rice cake.'),
                                const SizedBox(height: 8),
                                _buildNumberedStep(2, 'Enjoy the crunchy, creamy snack!'),
