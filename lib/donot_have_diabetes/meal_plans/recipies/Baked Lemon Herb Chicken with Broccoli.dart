...
class D8RecipeDetailScreen extends StatefulWidget {
  const D8RecipeDetailScreen({Key? key}) : super(key: key);

  @override
  _D8RecipeDetailScreenState createState() => _D8RecipeDetailScreenState();
}

class _D8RecipeDetailScreenState extends State<D8RecipeDetailScreen> {
  ...
  // Recipe data
  final String recipeName = 'Baked Lemon Herb Chicken with Broccoli';
    ...
    try {
      ...
      Map<String, dynamic> recipeData = {
        ...
        'instructions': [
          ...
          'Season chicken with olive oil, oregano, garlic powder, salt, and pepper. Place lemon slices on top of chicken.',
          'Arrange broccoli around the chicken on a baking sheet.',
    ...
    return Scaffold(
      body: Stack(
        children: [
          // Background Image
          Image.asset(
            'lib/donot_have_diabetes/meal_plans/meal_images/baked_lemon.jpeg',
                          ...
                          Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                // Title
                                const Text(
                                  'Baked Lemon Herb Chicken with Broccoli',
                                  style: TextStyle(
                                    fontSize: 32,
                                ...
                                _buildBulletPoint('2 chicken breasts'),
                                _buildBulletPoint('1 tbsp olive oil'),
                                _buildBulletPoint('1 lemon (sliced)'),
                                _buildBulletPoint('1 tsp dried oregano'),
                                _buildBulletPoint('1 tsp garlic powder'),
                                _buildBulletPoint('1 cup broccoli florets'),
                                ...
                                const SizedBox(height: 8),
                                _buildNumberedStep(2, 'Season chicken with olive oil, oregano, garlic powder, salt, and pepper. Place lemon slices on top of chicken.'),
                                const SizedBox(height: 8),
                                _buildNumberedStep(3, 'Arrange broccoli around the chicken on a baking sheet.'),
                                const SizedBox(height: 8),
                                _buildNumberedStep(3, 'Bake for 20-25 minutes until chicken is cooked through and broccoli is tender.'),
