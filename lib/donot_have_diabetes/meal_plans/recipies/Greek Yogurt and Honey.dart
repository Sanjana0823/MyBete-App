...
class S2RecipeDetailScreen extends StatefulWidget {
  const S2RecipeDetailScreen({Key? key}) : super(key: key);

  @override
  _S2RecipeDetailScreenState createState() => _S2RecipeDetailScreenState();
}

class _S2RecipeDetailScreenState extends State<S2RecipeDetailScreen> {
  ...
  // Recipe data
  final String recipeName = 'Greek Yogurt and Honey';
    ...
    try {
      ...
      Map<String, dynamic> recipeData = {
        ...
        'instructions': [
          ...
          'Stir and enjoy the creamy treat!',
        ],
    ...
    return Scaffold(
      body: Stack(
        children: [
          // Background Image
          Image.asset(
            'lib/donot_have_diabetes/meal_plans/meal_images/Greek Yogurt and Berries.jpeg',
                          ...
                          Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                _buildBulletPoint('1 cup Greek yogurt (unsweetened)'),
                                ...
                                const SizedBox(height: 8),
                                _buildNumberedStep(1, 'Scoop the yogurt into a bowl.'),
                                const SizedBox(height: 8),
                                _buildNumberedStep(2, 'Drizzle with honey on top.'),
                                const SizedBox(height: 8),
                                _buildNumberedStep(3, 'Stir and enjoy the creamy treat!'),
