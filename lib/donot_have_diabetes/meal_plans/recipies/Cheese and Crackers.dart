...
class S7RecipeDetailScreen extends StatefulWidget {
  const S7RecipeDetailScreen({Key? key}) : super(key: key);

  @override
  _S7RecipeDetailScreenState createState() => _S7RecipeDetailScreenState();
}

class _S7RecipeDetailScreenState extends State<S7RecipeDetailScreen> {
  ...
  // Recipe data
  final String recipeName = 'Cheese and Crackers';
    ...
    return Scaffold(
      body: Stack(
        children: [
          // Background Image
          Image.asset(
            'lib/donot_have_diabetes/meal_plans/meal_images/cheese crackers.png',
                          ...
                          Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                _buildBulletPoint('2 oz cheese (any variety)'),
                                _buildBulletPoint('5-6 whole grain crackers'),
                                ...
                                const SizedBox(height: 8),
                                _buildNumberedStep(1, 'Slice the cheese into pieces.'),
                                const SizedBox(height: 8),
                                _buildNumberedStep(2, 'Serve with whole grain crackers.'),
                                const SizedBox(height: 8),
                                _buildNumberedStep(2, 'Enjoy this classic, easy snack!'),
