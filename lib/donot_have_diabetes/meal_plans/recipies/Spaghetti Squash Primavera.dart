...
class D7RecipeDetailScreen extends StatefulWidget {
  const D7RecipeDetailScreen({Key? key}) : super(key: key);

  @override
  _D7RecipeDetailScreenState createState() => _D7RecipeDetailScreenState();
}

class _D7RecipeDetailScreenState extends State<D7RecipeDetailScreen> {
  ...
  // Recipe data
  final String recipeName = 'Spaghetti Squash Primavera';
    ...
    try {
      ...
      Map<String, dynamic> recipeData = {
        ...
        'instructions': [
          ...
          'Cut spaghetti squash in half, remove seeds, drizzle with olive oil, and roast for 35-40 minutes.',
          'In a pan, heat olive oil and sauté garlic, zucchini, bell peppers, and cherry tomatoes for 5-7 minutes.',
          'Scrape the roasted squash into strands with a fork. Toss with the veggie mixture and balsamic vinegar.',
                          ...
                          Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                _buildBulletPoint('1 spaghetti squash'),
                                _buildBulletPoint('1 tbsp olive oil'),
                                _buildBulletPoint('1 cup cherry tomatoes (halved)'),
                                _buildBulletPoint('1 cup zucchini (sliced)'),
                                _buildBulletPoint('½ cup bell peppers (sliced)'),
                                _buildBulletPoint('2 garlic cloves (minced)'),
                                _buildBulletPoint('1 tbsp balsamic vinegar'),
                                _buildBulletPoint('Fresh basil (for garnish)'),
                                ...
                                const SizedBox(height: 8),
                                _buildNumberedStep(2, 'Cut spaghetti squash in half, remove seeds, drizzle with olive oil, and roast for 35-40 minutes.'),
                                const SizedBox(height: 8),
                                _buildNumberedStep(3, 'In a pan, heat olive oil and sauté garlic, zucchini, bell peppers, and cherry tomatoes for 5-7 minutes.'),
                                const SizedBox(height: 8),
                                _buildNumberedStep(3, 'Scrape the roasted squash into strands with a fork. Toss with the veggie mixture and balsamic vinegar.'),
                                const SizedBox(height: 8),
                                _buildNumberedStep(3, 'Garnish with fresh basil and serve!'),
