...
class D9RecipeDetailScreen extends StatefulWidget {
  const D9RecipeDetailScreen({Key? key}) : super(key: key);

  @override
  _D9RecipeDetailScreenState createState() => _D9RecipeDetailScreenState();
}

class _D9RecipeDetailScreenState extends State<D9RecipeDetailScreen> {
  ...
  // Recipe data
  final String recipeName = 'Quinoa and Roasted Vegetable Bowl';
    ...
    try {
      ...
      Map<String, dynamic> recipeData = {
        ...
        'instructions': [
          ...
          'Toss sweet potato and broccoli with olive oil, paprika, salt, and pepper. Roast for 20-25 minutes.',
          'In a bowl, serve quinoa topped with roasted veggies and drizzle with tahini.',
    ...
    return Scaffold(
      body: Stack(
        children: [
          // Background Image
          Image.asset(
            'lib/donot_have_diabetes/meal_plans/meal_images/Healthy Quinoa Salad with Roasted Vegetables - Gluten-Free & Delicious Recipe!.jpeg',
                          ...
                          Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                _buildBulletPoint('1 cup cooked quinoa'),
                                _buildBulletPoint('1 cup broccoli florets'),
                                _buildBulletPoint('1 sweet potato (cubed)'),
                                _buildBulletPoint('1 tbsp olive oil'),
                                _buildBulletPoint('1 tsp paprika'),
                                _buildBulletPoint('Salt and pepper to taste'),
                                _buildBulletPoint('1 tbsp tahini (optional)'),
                                ...
                                const SizedBox(height: 8),
                                _buildNumberedStep(2, 'Toss sweet potato and broccoli with olive oil, paprika, salt, and pepper. Roast for 20-25 minutes.'),
                                const SizedBox(height: 8),
                                _buildNumberedStep(3, 'In a bowl, serve quinoa topped with roasted veggies and drizzle with tahini.'),
