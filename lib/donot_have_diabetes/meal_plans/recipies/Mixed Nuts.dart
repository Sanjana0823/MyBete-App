...
class S6RecipeDetailScreen extends StatefulWidget {
  const S6RecipeDetailScreen({Key? key}) : super(key: key);

  @override
  _S6RecipeDetailScreenState createState() => _S6RecipeDetailScreenState();
}

class _S6RecipeDetailScreenState extends State<S6RecipeDetailScreen> {
  ...
  // Recipe data
  final String recipeName = 'Mixed Nuts';
  ...
  Future<void> _saveRecipe() async {
    ...
    try {
      ...
      Map<String, dynamic> recipeData = {
        ...
        'category': category,
        'ingredients': [
          '¼ cup mixed nuts (almonds, walnuts, cashews, etc.)',



        ],
        'instructions': [
          'Simply grab a handful or measure out ¼ cup of mixed nuts.',
    ...
    return Scaffold(
      body: Stack(
        children: [
          // Background Image
          Image.asset(
            'lib/donot_have_diabetes/meal_plans/meal_images/Healthy Trail Mix.jpeg',
                          ...
                          Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                _buildBulletPoint('¼ cup mixed nuts (almonds, walnuts, cashews, etc.)'),
                                ...
                                const SizedBox(height: 8),
                                _buildNumberedStep(1, 'Simply grab a handful or measure out ¼ cup of mixed nuts.'),
                                const SizedBox(height: 8),
                                _buildNumberedStep(2, 'Enjoy as a quick and nutritious snack!'),
