...
class S4RecipeDetailScreen extends StatefulWidget {
  const S4RecipeDetailScreen({Key? key}) : super(key: key);

  @override
  _S4RecipeDetailScreenState createState() => _S4RecipeDetailScreenState();
}

class _S4RecipeDetailScreenState extends State<S4RecipeDetailScreen> {
  ...
  // Recipe data
  final String recipeName = 'Cucumber with Lemon and Salt';
  final int calories = 25;
    ...
    try {
      ...
      Map<String, dynamic> recipeData = {
        ...
        'instructions': [
          ...
          'Squeeze lemon juice over the cucumber slices.',
          'Sprinkle with a pinch of salt.',
          'Enjoy this refreshing, hydrating snack!',
        ],
    ...
    return Scaffold(
      body: Stack(
        children: [
          // Background Image
          Image.asset(
            'lib/donot_have_diabetes/meal_plans/meal_images/Easy Simple Green Salad.jpeg',
                          ...
                          Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                const SizedBox(height: 8),
                                _buildNumberedStep(1, 'Slice the cucumber into rounds.'),
                                const SizedBox(height: 8),
                                _buildNumberedStep(2, 'Squeeze lemon juice over the cucumber slices.'),
                                const SizedBox(height: 8),
                                _buildNumberedStep(3, 'Sprinkle with a pinch of salt.'),
                                const SizedBox(height: 8),
                                _buildNumberedStep(3, 'Enjoy this refreshing, hydrating snack!'),
