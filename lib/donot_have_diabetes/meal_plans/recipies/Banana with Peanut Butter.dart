...
class S1RecipeDetailScreen extends StatefulWidget {
  const S1RecipeDetailScreen({Key? key}) : super(key: key);

  @override
  _S1RecipeDetailScreenState createState() => _S1RecipeDetailScreenState();
}

class _S1RecipeDetailScreenState extends State<S1RecipeDetailScreen> {
  ...
  // Recipe data
  final String recipeName = 'Banana with Peanut Butter';
    ...
    try {
      ...
      Map<String, dynamic> recipeData = {
        ...
        'instructions': [
          ...
          'Spread or dip the slices in peanut butter.',
          'Enjoy this sweet and savory snack!',
           ],
    ...
    return Scaffold(
      body: Stack(
        children: [
          // Background Image
          Image.asset(
            'lib/donot_have_diabetes/meal_plans/meal_images/Peanut Butter Banana Bites.jpeg',
                          ...
                          Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                _buildBulletPoint('2 tbsp peanut butter (or almond butter)'),
                                ...
                                const SizedBox(height: 8),
                                _buildNumberedStep(1, 'Slice the banana into rounds.'),
                                const SizedBox(height: 8),
                                _buildNumberedStep(2, 'Spread or dip the slices in peanut butter.'),
                                const SizedBox(height: 8),
                                _buildNumberedStep(3, 'Enjoy this sweet and savory snack!'),
